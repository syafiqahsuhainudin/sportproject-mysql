...
scope="request"/>
  ...
  <section class="contact-section section_padding" id="signout">
    <div class="container">
      ...
      <div class="row">
        <div class="col-12">
          <h2 class="contact-title">Booking update</h2>
        </div>
        <div class="col-lg-8">
          <form class="form-contact contact_form" action="EditTaskAction" method="post" id="contactForm">
            <div class="row">
...
selected
              ...
              <div class="col-12">
                <div class="form-group">
                  <input class="form-control" name="quantity" id="quantity" type="quantity" value="${bookingbean.quantity}" required>
                </div>
              </div>
              <div class="col-sm-6">
                <div class="form-group">
                  <input class="form-control" name="date"  type="date" value="${bookingbean.date}" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Choose Date'" placeholder = 'Choose date'required>
                </div>
              </div>
              <div class="col-sm-6">
                <div class="form-group">
                  <input class="form-control" name="statusbook" id="statusbook" type="hidden"   value="${bookingbean.statusbook}" required>
