...
<%@ page import="com.sport.model.EquipmentBean, com.sport.dao.EquipmentDA0,com.sport.controller.EquipmentController, java.sql.*, java.util.*" %>
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
      <%
   ...
   <body>
    <div class="container">
        <div class="table-wrapper">			
            ...
            <% List <EquipmentBean> equipments= EquipmentDA0.getAllRecords(); %>
            <table class="table table-striped">
                <thead>
                    <tr>
                        <th>Id</th>
                          <th style="width: 22%;">Name</th>
                        <th style="width: 22%;">Equipment Picture</th>
                        <th>Quantity</th>
                        <th>Action</th>
                       
                    </tr>
                    <% for(EquipmentBean p:equipments){ %>
                </thead>
                <tbody>
                    <tr>
                        <td><%= p.getEquip_id() %></td>
                        <td><%= p.getEquip_name() %></td>
                         <td><img src="data:image/jpg;base64,<%= p.getBase64Image()  %>" style=" max-height: 100px; max-width:100px; "/></td>
                        <td><%= p.getEquip_quantity() %></td>
                      
                        <td>
                         <a href="equipmentform.jsp" class="add" title="Add" data-toggle="tooltip"><i class="material-icons md-48">add_circle</i></a>
                            <a href="EquipmentController?action=update&equip_id=<%= p.getEquip_id()%>" class="edit" title="Edit" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
                          
                            <a href="EquipmentController?action=delete&equip_id=<%= p.getEquip_id()%>" class="delete" title="delete" data-toggle="tooltip" onclick="return confirm('Are you sure to delete <%= p.getEquip_id() %>?')"><i class="material-icons">&#xE872;</i></a>
