 ...
 */
@WebServlet("/EditBookingAction")
public class EditBookingAction extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		boolean status = bookingManager.updateTask(bb);
		
		
		// forward to Home page
		// we use response.sendRedirect since the ViewTasks is doGet()
		// and this is doPost()
		response.sendRedirect("staffbooking.jsp");
