...
<%@ page import="com.sport.model.BookingBean, com.sport.manager.BookingManager,com.sport.controller.AdminBookingController, java.sql.*, java.util.*" %>
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    <%
   ...
   <body>
    <div class="container">
        <div class="table-wrapper">			
            ...
            <% List<BookingBean> bookings = BookingManager.getAllBooking();%>
            <table class="table table-striped">
                ...
                <tbody>
                    <tr>
                        <td><%= p.getBooking_id() %></td>
                           <td><%= p.getMatric_no() %></td>
                        <td><%= p.getEquip_namesB() %></td>
  
                        <td><%= p.getDate() %></td>
                         <td><%= p.getQuantity() %></td>
                          <td><%= p.getStatusbook() %></td>
                       
                      
                        <td>
                           <a href="EditBookingStatus?booking_id=<%= p.getBooking_id() %>" class="edit" title="Update status" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
