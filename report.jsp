...
<%@ page import="com.sport.dao.reportDAO,com.sport.controller.ReportController, java.sql.*, java.util.*" %>
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    <%
    ...
    <div class="container">
        <div class="table-wrapper">			
            <div class="table-title">
                ...
                </div>  <% List <BookingBean> reports= reportDAO.getAllRecords(); %>
