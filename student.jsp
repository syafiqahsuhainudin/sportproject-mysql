            ...
            <div class="table-title">
                <div class="row">
                    ...
                    <div class="col-sm-6">
                      ...
                      <% List <UserBean> accounts = AccountDAO.getAllRecords();
%>
            <table class="table table-striped">
                ...
                <thead>
                    <tr>
                        <th>Id</th>
                         <th style="width: 22%;"> Full Name</th>
                          <th style="width: 22%;">No matric</th>
                    ...
                    <% for(UserBean p:accounts){%>
                    
                </thead>
                <tbody>
                    <tr>
                        <td><%= p.getUserid() %></</td>
                         <td><%= p.getNo_matric() %></</td>
                         <td><%= p.getFullname() %></</td>
                         <td><%= p.getEmail() %></</td>
                         <td><%= p.getNo_phone() %></</td>
                         <td>*********</</td>
                        <td>
                            <a href="AccountController?action=delete&userid=<%= p.getUserid() %>" class="delete" title="Delete" data-toggle="tooltip" onclick="return confirm('Are you sure to delete <%= p.getFullname() %>?')"><i class="material-icons">&#xE872;</i></a>
