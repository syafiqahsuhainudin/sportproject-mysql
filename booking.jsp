...
<%@ page import="com.sport.model.BookingBean, com.sport.manager.BookingManager, java.sql.*, java.util.*" %>
<%@ page import="com.sport.model.EquipmentBean, com.sport.manager.EquipmentManager, java.sql.*, java.util.*" %>
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
  <%
    ...
    <div class="container">
        <div class="table-wrapper">			
                    ...
                    <div class="col-sm-6">
                        <div class="search-box">
							<div class="input-group">								
								<input type="text" id="search" class="form-control" placeholder="Search by booking status">
                                <span class="input-group-addon"><i class="material-icons">&#xE8B6;</i></span>
							</div>
                        </div>
                    </div>
                </div> <jsp:useBean id="books" 
            ...
            <table class="table table-striped">
                <thead>
                    <tr>                      
                        <th>Id</th>
                          ...
                          <th style="width: 22%;">Matric Number</th>
                ...
                </thead><c:forEach var="t" items="${books}"> 
                <tbody>
                    <tr>
                        <td>${t.booking_id}</td>
                           <td>${account.fullname}</td>
                        <td>${account.no_matric}</td>
                        ...
                        <td>
                            <a href="EditTask?booking_id=${t.booking_id}" class="edit" title="Edit or see Details" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
                            <a href="DeleteTask?booking_id=${t.booking_id}" class="delete" title="Delete" data-toggle="tooltip"  onclick="return confirm('Are you sure to delete ${t.booking_id}?')"><i class="material-icons">&#xE872;</i></a>
