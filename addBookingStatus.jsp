...
<h1>Booking Succesfully send!</h1>
<br/><br/><br/>
  ...
  <tr>
            <td>Equipment Id</td>
            <td><c:out value="${bookingbean.equipmentBean.equip_id}"/></td>
        </tr>
        <tr>
            <td>Quantity</td>
            <td><c:out value="${bookingbean.quantity}"/></td>
        </tr>
        <tr>
         <td>Date</td> 
          <td> <c:out value="${bookingbean.date}"/> </td>
        </tr>
        <tr>
         <td>Status</td> 
          <td> <c:out value="${bookingbean.statusbook}"/> </td>
        </tr>
 </table></c:if>
                      <a href="ViewTasks">Back</a>          </div>
                </div>
            </div>
            </div>
        </div>
