        ...
        <div class="col-lg-8">
          <form class="form-contact contact_form" action="EquipmentController" method="post" id="contactForm">
            <div class="row">
              ...
              <div class="col-sm-6">
                <div class="form-group">
                 <!--   <input type="file" id="pic" name="filepath" accept="image/png, image/jpeg"/ > 
				                               <h1 style="color:#C23A3A; display:none;" id="errmsg7">*Animals Picture not entered!!!....</h1>-->
				                              <input type="file" id="filepath" name="filepath"  accept="image/*" class="form-control"onfocus="this.placeholder = ''" onblur="this.placeholder = 'Choose Picture'" placeholder = 'Choose Picture'required >	
												<img id="output" style="width:15%; margin:0.2em;"/> 						        
                </div>
              </div>
               <div class="col-12">
                <div class="form-group">
                  <input class="form-control" name="equip_name"  type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Equipment name'" placeholder = 'Enter Equipment name'required>
                </div>
              </div>
              <div class="col-12">
                <div class="form-group">
                  <input class="form-control" name="equip_quantity" id="equip_quantity" type="number" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Quantity'" placeholder = 'Enter quantity'required>
                </div>
              </div>
            ...
            <div class="form-group mt-3"> 
              ...
              <button type="submit" class="button button-contactForm">Add Equipment</button>  &nbsp<a href="staffequipment.jsp"><i class="material-icons md-48">arrow_back</i>Back</a>
            </div>
          </form>
