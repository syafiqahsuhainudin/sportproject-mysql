        ...
        <div class="container-fluid">
            <div class="row justify-content-center ">
                <div class="col-xl-5">
                 ...
                 <form action="AccountStaffController" method="post">
			    <div id="main" class="wrapper style1" align="center">
			      <div class="container2" style="width:50%;" >
			      	<h2>Update Account</h2>
			      	<table> <input type="hidden" name="action" value="update" /><input type="hidden" name="id"value="<c:out value="${staffacc.id}"/>"  />
			      		<tr>
					              <td style ="background-color:#F3FEDC;"><strong>Staff : </strong></td>
			                     <td> <input type="text" name="staff_id" size="50"value="<c:out value="${staffacc.staff_id}"/>" placeholder="Staff ID" readonly/>
			                </td>
			      		</tr>
			      		<tr>
			      			<td style ="background-color:#F3FEDC;"><strong>Full Name: </strong></td>
			                <td><input type="text" name="staff_name"size="50" value="<c:out value="${staffacc.staff_name}"/>"  placeholder="Full Name"  readonly/></td>
			      		</tr>
			      		<tr>
			      			<td style ="background-color:#F3FEDC;"><strong>Phone Number: </strong></td>
			                <td><input type="text" name="staff_phone"size="50" value="<c:out value="${staffacc.staff_phone}"/>"  placeholder="Phone Number"   /></td>
			      		</tr>
			      		<tr>
			      			<td style ="background-color:#F3FEDC;"><strong>Email: </strong></td>
			                <td><input type="email" name="staff_email" value="<c:out value="${staffacc.staff_email}"/>" size="50" placeholder="Email"   /></td>
			      		</tr>
			      		<tr>
			      			<td style ="background-color:#F3FEDC;"><strong>Password: </strong></td>
			                <td><input type="password" name="staff_password" size="50" value="<c:out value="${staffacc.staff_password}"/>"  placeholder="Password"  /></td>
			      		</tr>	
			      	</table>
	<br><br><input type="submit" value="Submit" class="primary fit">&nbsp
							<input type="reset" value="Cancel" class="fit">
			      </div>
				</div>
              </form>  </div>
                </div>
