                ...
                <div class="row align-items-center">
                  ...
                  <div class="col-md-8 col-xl-6">
                      <div class="sub_header_social_icon float-right">
                        ...
                        <a href="#" class="logout_icon"><i class="ti-arrow-right"></i>LOGOUT</a>
                      </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                <ul class="navbar-nav mr-auto">
                                    <li class="nav-item active">
                                        <a class="nav-link active" href="userindex.jsp">Home</a>
                                    </li>
                                    <li class="nav-item">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="about_text">
                        ...
                        <h4>About us</h4>
                        <h2>Welcome &nbsp ${account.fullname}!.
                          to Equipment system, You logged in as ${account.fullname}.</h2><br>
                        Hope you have a productive day today :-)<br>
