            ...
            <div class="row align-content-center">
                <div class="col-lg-7 col-xl-5">
                    ...
                    Booking</h1>
                        ...
                        <a href="userhome.jsp" class="btn_1">LOG IN AS STUDENT <span class="ti-angle-right"></span> </a>  &nbsp <a href="loginStaff.jsp" class="btn_1"> LOG IN AS STAFF <span class="ti-angle-right"></span> </a>
                    </div>
                </div>
            </div>
        </div>
